 ...
 */
public class IgualOperator extends CondicionalOperator {

    private final String OPERADOR = "==";

    public IgualOperator(Triplete operando1, Triplete operando2, List<Triplete> trip1, List<Triplete> trip2) {
