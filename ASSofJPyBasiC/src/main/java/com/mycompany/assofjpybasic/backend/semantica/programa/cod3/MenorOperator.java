 ...
 */
public class MenorOperator extends CondicionalOperator {

    private final String OPERADOR = "<";

    public MenorOperator(Triplete operando1, Triplete operando2, List<Triplete> trip1, List<Triplete> trip2) {
    ...
    public MenorOperator(Triplete operando1, Triplete operando2) {
