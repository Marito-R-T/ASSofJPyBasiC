 ...
 */
public class NoIgualOperator extends CondicionalOperator {

    private final String OPERADOR = "!=";

    public NoIgualOperator(Triplete operando1, Triplete operando2, List<Triplete> trip1, List<Triplete> trip2) {
