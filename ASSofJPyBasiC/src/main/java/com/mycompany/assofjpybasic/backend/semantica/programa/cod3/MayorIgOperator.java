 ...
 */
public class MayorIgOperator extends CondicionalOperator {

    private final String OPERADOR = ">=";

    public MayorIgOperator(Triplete operando1, Triplete operando2, List<Triplete> trip1, List<Triplete> trip2) {
