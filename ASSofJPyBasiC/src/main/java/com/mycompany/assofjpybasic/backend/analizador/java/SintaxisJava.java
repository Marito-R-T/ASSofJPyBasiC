...
public class SintaxisJava extends java_cup.runtime.lr_parser {
     ...
     */
    @Deprecated
    public SintaxisJava(java_cup.runtime.Scanner s) {
        super(s);
    }
     ...
     * Constructor which sets the default scanner.
     */
    public SintaxisJava(java_cup.runtime.Scanner s, java_cup.runtime.SymbolFactory sf) {
        super(s, sf);
    }
        ...
        public final java_cup.runtime.Symbol CUP$SintaxisJava$do_action_part00000000(
            ...
            switch (CUP$SintaxisJava$act_num) {
                ...
                case 5: // CLASS ::= publicc classs id llavea NT$0 STATEMENTS_CLASS llavec
                {
                    ...
                    tabla.eliminarAmbito(TablaJava.AMBITO);
                    TablaJava.AMBITO -= 1;
                    tabla = null;
                ...
                case 21: // STATEMENTS_METODO ::= STATEMENT_METODO STATEMENTS_METODO
                {
                    ...
                    if (e2 != null) {
                        e2.add(0, e1);
                        if (e1 instanceof ListaIf && ((ListaIf) e1).isRet() && e2.isRet()) {
                            syntax_error(getS());
                        }
                        RESULT = e2;
                    } else {
                        StatementsJava states = new StatementsJava();
                        states.add(e1);
                        if (e1 instanceof ListaIf) {
                            states.setRet(((ListaIf) e1).isRet());
                        }
                        RESULT = states;
                    }
                ...
                case 44: // INICIO ::= THIS id
                {
                    ...
                    int num;
                    if (e0) {
                        num = tabla.existeVarGlobal(new VariableJava(e1, TablaJava.AMBITO));
                    } else {
                        num = tabla.existeVar(new VariableJava(e1, TablaJava.AMBITO));
                    }
                    if (num == -1) {
                        syntax_error(getS());
                    } else {
                        RESULT = new OperacionJava(num);
                    }
                ...
                case 50: // IF_ELSE ::= iff para CONDICION parc BLOQUE ELSEIF ELSE
                {
                    ...
                    IfOperacion op = new IfOperacion(e2);
                    e3.getIfs().add(0, op);
                    if (e4 != null) {
                        e3.getIfs().add(e4);
                        e3.verRetornabilidad();
                    } else {
                        e3.setRet(false);
                    }
                    RESULT = e3;
                ...
                case 53: // ELSE ::= elsee BLOQUE
                {
                    ...
                    IfOperacion op = new IfOperacion(e1);
                    RESULT = op;
