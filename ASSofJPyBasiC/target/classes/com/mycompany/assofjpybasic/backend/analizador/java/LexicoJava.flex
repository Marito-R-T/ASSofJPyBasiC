...
<YYINITIAL> ("break") {System.out.print(yytext()); return new Symbol(SintaxisJavaSym.breakk, yycolumn, yyline, yytext());}
<YYINITIAL> ("do") {System.out.print(yytext()); return new Symbol(SintaxisJavaSym.doo, yycolumn, yyline, yytext());}
